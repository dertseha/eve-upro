upro.model.proxies.UserSettingsProxy = Class.create(Proxy,
      {
         initialize: function($super)
         {
            ...
            this.createRoutingRule("MaxSecurity", 1, false, 10, upro.nav.finder.PathFinderCostRuleMaxSecurity,
                  "maxSecurity");
            this.createRoutingRule("Jumps", 2, true, 0, upro.nav.finder.PathFinderCostRuleJumps, "jumps");
            this.createRoutingRule("JumpFuel", 3, false, 0, upro.nav.finder.PathFinderCostRuleJumpFuel, "jumpFuel");
         },

         createRoutingRule: function(ruleType, index, inUse, parameter, pathFinderConstructor, name)
         {
