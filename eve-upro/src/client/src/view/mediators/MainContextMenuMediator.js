      ...
      .create(upro.view.mediators.AbstractContextMenuMediator,
            {
               ...
               updateCommandRoutingCapabilities: function()
               {
                  ...
                  { // jump drive
                     ...
                     var belowMaximum = range < upro.model.RoutingCapabilities.jumpDrive.rangeMaximum;
                     var aboveMinimum = range > upro.model.RoutingCapabilities.jumpDrive.rangeMinimum;
                     ...
                     this.commandRoutingCapJumpDriveMore.setLabel(belowMaximum ? upro.res.text.Lang.format(
                           "routing.caps.jumpDrive.rangeSet", range, range
                                 + upro.model.RoutingCapabilities.jumpDrive.rangeStep) : upro.res.text.Lang.format(
